...
class EmpresaEx3 {
	String nome;
	String cnpj;
	FuncionarioEx3[] funcionarios;
	FilialEx3[] filiais;
	int idFuncionario = 0;
	int idFilial = 0;

	void adicionaFuncionario(FuncionarioEx3 funcionario) {
		this.funcionarios[this.idFuncionario] = funcionario;
		this.idFuncionario++;

	}

	void adicionaFilial(FilialEx3 filial) {
...
//		cria estância de empresa
		EmpresaEx3 empresa = new EmpresaEx3();

//		cria array de 10 posições em empresa.funcionarios
		empresa.funcionarios = new FuncionarioEx3[10];

//		cia novas estâncias de funcionarios
		FuncionarioEx3 funcionario1 = new FuncionarioEx3();
		FuncionarioEx3 funcionario2 = new FuncionarioEx3();
		FuncionarioEx3 funcionario3 = new FuncionarioEx3();

//		atribui valores aos funcionarios
		...
		funcionario1.dataAdmissão = new DataAdmissaoEx3();
		...
		funcionario2.dataAdmissão = new DataAdmissaoEx3();
		...
		funcionario3.dataAdmissão = new DataAdmissaoEx3();
